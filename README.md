...
## webargs (kinetic) - 1.3.4-2

The packages in the `webargs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic webargs` on `Mon, 16 Apr 2018 10:25:28 -0000`
...
## python-webargs (kinetic) - 1.3.4-1

The packages in the `python-webargs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic python-webargs` on `Mon, 16 Apr 2018 06:57:15 -0000`

The `python-webargs` package was released.

Version of package(s) in repository `python-webargs`:
...
## webargs (indigo) - 1.3.4-8

The packages in the `webargs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --rosdistro indigo webargs` on `Fri, 24 Mar 2017 08:04:19 -0000`
...
## webargs (jade) - 1.3.4-3

The packages in the `webargs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade webargs` on `Thu, 23 Mar 2017 01:55:54 -0000`
...
## webargs (jade) - 1.3.4-2

The packages in the `webargs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade webargs` on `Thu, 23 Mar 2017 01:38:30 -0000`
...
## webargs (jade) - 1.3.4-1

The packages in the `webargs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade webargs` on `Fri, 06 Jan 2017 08:04:58 -0000`
...
## webargs (kinetic) - 1.3.4-0

The packages in the `webargs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic webargs` on `Mon, 02 Jan 2017 07:48:44 -0000`
...
## webargs (indigo) - 1.3.4-6

The packages in the `webargs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo webargs` on `Tue, 15 Nov 2016 00:33:02 -0000`
...
## webargs (indigo) - 1.3.4-5

The packages in the `webargs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo webargs` on `Mon, 14 Nov 2016 08:25:40 -0000`
...
## webargs (indigo) - 1.3.4-4

The packages in the `webargs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo webargs` on `Mon, 14 Nov 2016 08:05:53 -0000`
...
## webargs (indigo) - 1.3.4-3

The packages in the `webargs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo webargs` on `Mon, 14 Nov 2016 07:49:21 -0000`
